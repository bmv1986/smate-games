// classic/main.js
const packages = [
    { id: 'chgk_42_questions', name: '42 вопроса из базы ЧГК', file: 'data/packages/chgk_42_questions.json' },
    { id: 'package1', name: 'Лига старта. Этап 1', file: 'data/packages/package1.json' }
];
...
function loadQuestionCount(pkg, element) {
    // Используем полный путь от корня текущей папки (classic)
    fetch(pkg.file)
        .then(response => {
