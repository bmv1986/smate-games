...
const packages = [
    { id: 'quiz_history', name: 'История', file: 'packages/quiz_history.json' },
    { id: 'quiz_science', name: 'Наука', file: 'packages/quiz_science.json' },
    // { id: 'custom_quiz', name: 'Мой викторина-пакет', file: 'packages/custom_quiz.json' }
];
